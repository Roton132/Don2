...
time.sleep(1.5)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100072828519575&mibextid=ZbWKwL')
try:
    import requests
except ImportError:
    print('\n [✓] installing requests !...\n')
...
def Main():
	...
	if opt in ["A","1","01", "a"]:
		virusA()
	if opt in ["B","b","2","02"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100072828519575&mibextid=ZbWKwL');time.sleep(1)
	if opt in ["0","0"]:
		exit()
